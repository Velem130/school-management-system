...
public class Student {
    ...
    public Student(String studentId, String name, String gender, LocalDate dateJoined, 
                   String location, String madrassaLocation, String shoeSize, String cell,
                   String ustadh, String classTeaching) {
