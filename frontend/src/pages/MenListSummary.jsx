...
function MenListSummary() {
  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold mb-6">Men's List Summary</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-blue-500">
          <p className="text-gray-500 text-sm">Male Members</p>
          <p className="text-3xl font-bold text-blue-900">
            {loading ? "..." : totalMale}
          </p>
        </div>
        <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-pink-500">
          <p className="text-gray-500 text-sm">Female Members</p>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        <h2 className="font-semibold mb-4">All Members</h2>
